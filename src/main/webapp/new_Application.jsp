...
<title>Online Birth Certificate - New Application</title>
</head>
<body>
...
<div class="container card shadow mt-5">
    <div class="card-body">
		<h5 class="p-2" style="border-bottom: 2px solid orange">New Application</h5>
		...
		<table id="example" class="table table-striped table-bordered" style="width:100%">
			...
			<tbody>
			      <%				  
				    ...
				    List<Application> list = dao.getNewApplication();
